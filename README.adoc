...
대나무숲 익명 게시판의 설계 의도, 트러블슈팅, 면접에서 설명하기 좋은 기술 포인트는 link:docs/technical-notes.md[기술 노트]에 누적합니다.
...
* https://spring.io/guides/gs/accessing-data-rest/[Accessing JPA Data]
